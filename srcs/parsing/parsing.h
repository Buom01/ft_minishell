...
/*   Updated: 2021/01/11 23:42:05 by badam            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		pp_replace(t_pp_state *st, ssize_t oldl, char *nwwd, t_string *str);
void		pp_strip(t_pp_state *st, ssize_t strip_len, t_string *str);
